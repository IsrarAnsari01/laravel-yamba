        ...
        <div class="row">
            <div class="col-lg-10">
                <div class="card bg-info mt-5 text-light">
                    <div class="card-body">
                        <h2 class="card-title lead"><i class="fa fa-edit"></i> Welcome here please Enroll yourself</h2>
                    </div>
                </div>
                <div class="card">
                    <div class="card-body">
                        <form method="post" action="addUser">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" name="password" pattern="[a-zA-Z0-9!@#$%^&*() ]{4,}" class="form-control" autocomplete="off" id="stuNumber">
                            </div>
